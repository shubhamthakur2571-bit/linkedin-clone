...
function NotificationItem({ notification, onRead, onDelete }) {
  ...
  return (
    <div
      className={`flex items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 relative group cursor-pointer ${
    ...
    >
      ...
      <div className="flex-1">
        <div className="text-sm text-gray-900 dark:text-gray-100">{notification.text}</div>
      ...
      >
        <button className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-100">
          <FaEllipsisH />
        </button>
        {showMenu && (
          <div className="absolute right-0 mt-2 w-32 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow z-10">
            <button
              className="flex items-center w-full px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-100"
              onClick={(e) => {
                e.stopPropagation();
...
export default function Notifications() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
      {/* Sidebar */}
      <div className="hidden md:block w-1/4 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700">
        <ProfileSidebar />
      </div>
      {/* Main content */}
